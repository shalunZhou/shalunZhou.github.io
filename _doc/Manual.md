...
```yml
# Site settings
title: slzray Blog             # title of your website
SEOTitle: slzray Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“slzray Blog”** but I want the title shows in search engine is **“slzray的博客 | slzray Blog”** which is multi-language.
